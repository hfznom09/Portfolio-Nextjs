...
const Footer = () => {
  return (
    ...
    id="Contact" className="bg-center  text-center bg-cover h-screen w-screen  ">
      <h1 className="heading text-5xl text-white font-semibold pt-32 pb-20">
        Contact
        <span className="text-yellow-500 text-center"> Us</span>
      </h1>
      ...
      <div className="w-[80%] border-t-[2px] border-yellow-500 mt-[2rem] mx-auto grid grid-cols-1 items-center text-center">
        <div className="text-[12px] md:text-[14px] mt-8 text-white ">
          <p>
            <a>
              © Noman Anwar 
            </a>{" "}
